...
integer :: in_unit, i, datein, hourin, days, secs, nused, & 
           iyear, imonth, iday, ihour, imin, isec
real(r8) :: lat, lon, pres, wdir, wspd, uwnd, vwnd, oerr, &
...
read*,datestr
print*,'Do you want to include IR, VISIBLE, WV data, and SW IR?'
...
call get_time(set_date(iyear, imonth, iday, ihour, imin, isec), secs, days)
