...
!  module procedure insert_gts_obs_single, insert_gts_obs_multi, insert_gts_obs_gpsref   !problematic
  module procedure insert_gts_obs_single, insert_gts_obs_multi
