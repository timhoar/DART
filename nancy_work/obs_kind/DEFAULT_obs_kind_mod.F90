...
! kind strings are defined here. 
 ...
 ! kind for precipitation fall rate
    KIND_WEIGHTED_VELOCITY           = 32
...
integer, parameter, public :: max_obs_kinds = 85
...
! To include additional KINDS_ used by files other than obs_def files
! (e.g. model_mod.f90 or other utility modules), add them to the 'kind_files'
! variable of the &preprocess_nml namelist in the input.nml file.
