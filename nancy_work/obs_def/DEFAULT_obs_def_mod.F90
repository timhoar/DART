...
! in the model-specific work/input.nml file.   To add kinds only, add
! the files containing the kinds to the 'kind_files' variable of the
! &preprocess_nml namelist in the input.nml file.  preprocess comment
! lines must be present to flag the lines with kinds on them.
!
