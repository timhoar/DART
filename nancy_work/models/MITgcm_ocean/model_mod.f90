...
use    utilities_mod, only : register_module, error_handler, E_ERR, E_WARN, E_MSG, &
                             logfileunit, nmlfileunit, get_unit, nc_check, do_output, &
...
if (do_output()) write(nmlfileunit,*)'model_mod:namelist cal_NML',startDate_1,startDate_2
if (do_output()) write(nmlfileunit,nml=CAL_NML)
