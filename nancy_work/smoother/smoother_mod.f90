...
! FIXME: here is where you need to be able to get the prior/post inflation flavor
! to decide on the fly whether it needs a full state-vector-size array or not.
! also the flag saying whether to output or not should come in here, too.
