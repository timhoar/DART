...
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/select.f90 $
! $Id: select.f90 5074 2011-07-15 17:06:58Z thoar $
! $Revision: 5074 $
...
character(len=128), parameter :: &
   source   = "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/select.f90 $", &
