...
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/add_pert_where_high_refl.f90 $
! $Id: add_pert_where_high_refl.f90 5603 2012-03-15 20:45:30Z nancy $
! $Revision: 5603 $
...
character(len=128), parameter :: &
   source   =  "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/add_pert_where_high_refl.f90 $", &
   revision = "$Revision: 5603 $", &
   revdate  = "$Date: 2012-03-15 14:45:30 -0600 (Thu, 15 Mar 2012) $"
