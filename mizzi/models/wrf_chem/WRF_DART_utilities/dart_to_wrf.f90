...
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/dart_to_wrf.f90 $
! $Id: dart_to_wrf.f90 5708 2012-04-18 22:12:04Z nancy $
! $Revision: 5708 $
...
character(len=128), parameter :: &
   source   = "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/dart_to_wrf.f90 $", &
   revision = "$Revision: 5708 $", &
   revdate  = "$Date: 2012-04-18 16:12:04 -0600 (Wed, 18 Apr 2012) $"
