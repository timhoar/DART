...
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/replace_wrf_fields.f90 $
! $Id: replace_wrf_fields.f90 5833 2012-08-06 22:19:46Z nancy $
! $Revision: 5833 $
...
character(len=128), parameter :: source = &
 "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_DART_utilities/replace_wrf_fields.f90 $"
character(len=128), parameter :: revision = "$Revision: 5833 $"
character(len=128), parameter :: revdate  = "$Date: 2012-08-06 16:19:46 -0600 (Mon, 06 Aug 2012) $"
