...
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_BC/module_netcdf_interface.f90 $
! $Id: module_netcdf_interface.f90 5661 2012-04-06 21:04:52Z thoar $
! $Revision: 5661 $
...
character(len=128), parameter :: &
   source   = "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/models/wrf/WRF_BC/module_netcdf_interface.f90 $", &
   revision = "$Revision: 5661 $", &
   revdate  = "$Date: 2012-04-06 15:04:52 -0600 (Fri, 06 Apr 2012) $"
