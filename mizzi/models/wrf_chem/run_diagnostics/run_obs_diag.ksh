...
export EXP_DIR=/glade/scratch/mizzi/DART_TEST_AVE/${DIR_NAME}
...
cp ${DART_DIR}/diagnostics/matlab/plot_evolution.m ./.
cp ${DART_DIR}/diagnostics/matlab/plot_profile.m ./.
cp ${DART_DIR}/diagnostics/matlab/plot_rank_histogram.m ./.
cp ${DART_DIR}/models/wrf_chem/run_diagnostics/run_matlab_scripts/run_plot_evolution.m ./.
cp ${DART_DIR}/models/wrf_chem/run_diagnostics/run_matlab_scripts/run_plot_profile.m ./.
cp ${DART_DIR}/models/wrf_chem/run_diagnostics/run_matlab_scripts/run_plot_rank_histogram.m ./.
#
...
export ASIM_MIN_YY_STR=`echo $ASIM_MIN_DATE | cut -c1-4`
export ASIM_MIN_MM_STR=`echo $ASIM_MIN_DATE | cut -c5-6`
export ASIM_MIN_DD_STR=`echo $ASIM_MIN_DATE | cut -c7-8`
export ASIM_MIN_HH_STR=`echo $ASIM_MIN_DATE | cut -c9-10`
export ASIM_MAX_DATE_STR=`echo ${START_DATE} +${ASIM_PERIOD}h | ./advance_time` 
export ASIM_MAX_YY_STR=`echo $ASIM_MAX_DATE | cut -c1-4`
export ASIM_MAX_MM_STR=`echo $ASIM_MAX_DATE | cut -c5-6`
export ASIM_MAX_DD_STR=`echo $ASIM_MAX_DATE | cut -c7-8`
export ASIM_MAX_HH_STR=`echo $ASIM_MAX_DATE | cut -c9-10`
#
export ASIM_MIN_DATE_END=`echo ${END_DATE} -${ASIM_PERIOD}h | ./advance_time` 
export ASIM_MIN_YY_END=`echo $ASIM_MIN_DATE | cut -c1-4`
export ASIM_MIN_MM_END=`echo $ASIM_MIN_DATE | cut -c5-6`
export ASIM_MIN_DD_END=`echo $ASIM_MIN_DATE | cut -c7-8`
export ASIM_MIN_HH_END=`echo $ASIM_MIN_DATE | cut -c9-10`
export ASIM_MAX_DATE_END=`echo ${END_DATE} +${ASIM_PERIOD}h | ./advance_time` 
export ASIM_MAX_YY_END=`echo $ASIM_MAX_DATE | cut -c1-4`
export ASIM_MAX_MM_END=`echo $ASIM_MAX_DATE | cut -c5-6`
export ASIM_MAX_DD_END=`echo $ASIM_MAX_DATE | cut -c7-8`
export ASIM_MAX_HH_END=`echo $ASIM_MAX_DATE | cut -c9-10`
...
export NL_OBS_SEQUENC_LIST="'file_list.txt'"
...
export NL_RAT_CRI=5000.0
export NL_INPUT_QC_THRESHOLD=2.0
export NL_NREGIONS=1
export NL_LATLIM1=-90.
export NL_LATLIM2=90.
export NL_LONLIM1=0.
export NL_LONLIM2=360.
export NL_REG_NAMES="'Globe'"
