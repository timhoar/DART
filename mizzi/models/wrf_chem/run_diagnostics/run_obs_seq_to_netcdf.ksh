...
export RUN_DIR=/glade/scratch/mizzi/DART_OBS_SEQ_TO_NETCDF/MOPITT
...
export EXP_DIR=/glade/scratch/mizzi/DART_TEST_AVE/TEST_DIR
export HSI_EXP_DIR=/MIZZI/DART_TEST_AVE/TEST_DIR
#
...
cp ${DART_DIR}/diagnostics/matlab/link_obs.m ./.
cp ${DART_DIR}/diagnostics/matlab/plot_obs_netcdf.m ./.
cp ${DART_DIR}/diagnostics/matlab/plot_obs_netcdf_diffs.m ./.
cp ${DART_DIR}/models/wrf_chem/run_diagnostics/run_matlab_scripts/run_plot_obs_netcdf.m ./.
cp ${DART_DIR}/models/wrf_chem/run_diagnostics/run_matlab_scripts/run_plot_obs_netcdf_diffs.m ./.
#
