...
use       obs_def_mod, only : set_obs_def_location, set_obs_def_error_variance, &
                              ...
                              obs_def_type
use   obs_def_gps_mod, only : set_gpsro_excessphase
...
!------------------
   ...
   ! the set routine increments this itself
   ...
   if (valid) then
      ...
      if ( gpsref_form .ne. 1 ) then
         print*,'Not implemented yet! Return!'
         call set_gpsro_excessphase(gpsref_key, nx, ny, nz, rfict, ds, htop, subset)
