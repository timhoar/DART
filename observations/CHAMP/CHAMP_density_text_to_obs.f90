...
use      obs_kind_mod, only : CHAMP_DENSITY, SAT_RHO

implicit none

! version controlled file description for error handling, do not edit
character(len=*), parameter :: source   = 'CHAMP_density_text_to_obs.f90'
...
elseif (trim(observation_string) == 'SAT_RHO') then
   ...
   write(string2,*)'valid strings are "CHAMP_DENSITY" or "SAT_RHO"'
   call error_handler(E_ERR, 'CHAMP_density_text_to_obs', string1, &
                      source, revision, revdate, text2=string2)
endif  
