...
! kinds for CLM (Tim Hoar)
integer, parameter, public :: &
    KIND_SNOW_THICKNESS              = 88, &
    KIND_SNOW_WATER                  = 89, &
    KIND_SNOWCOVER_FRAC              = 90, &
    KIND_LIQUID_WATER                = 91, &
    KIND_ICE                         = 92, &
    KIND_LEAF_CARBON                 = 93, &
    KIND_LEAF_AREA_INDEX             = 94, &
    KIND_NET_CARBON_FLUX             = 95, &
    KIND_LATENT_HEAT_FLUX            = 96, &
    KIND_SENSIBLE_HEAT_FLUX          = 97
 
!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.
integer, parameter :: max_obs_generic = 97
...
obs_kind_names(88) = obs_kind_type(KIND_SNOW_THICKNESS,'KIND_SNOW_THICKNESS')
obs_kind_names(89) = obs_kind_type(KIND_SNOW_WATER,'KIND_SNOW_WATER')
obs_kind_names(90) = obs_kind_type(KIND_SNOWCOVER_FRAC,'KIND_SNOWCOVER_FRAC')
obs_kind_names(91) = obs_kind_type(KIND_LIQUID_WATER,'KIND_LIQUID_WATER')
obs_kind_names(92) = obs_kind_type(KIND_ICE,'KIND_ICE')
obs_kind_names(93) = obs_kind_type(KIND_LEAF_CARBON,'KIND_LEAF_CARBON')
obs_kind_names(94) = obs_kind_type(KIND_LEAF_AREA_INDEX,'KIND_LEAF_AREA_INDEX')
obs_kind_names(95) = obs_kind_type(KIND_NET_CARBON_FLUX,'KIND_NET_CARBON_FLUX')
obs_kind_names(96) = obs_kind_type(KIND_LATENT_HEAT_FLUX,'KIND_LATENT_HEAT_FLUX')
obs_kind_names(97) = obs_kind_type(KIND_SENSIBLE_HEAT_FLUX,'KIND_SENSIBLE_HEAT_FLUX')
