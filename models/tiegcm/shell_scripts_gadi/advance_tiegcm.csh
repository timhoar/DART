...
if ($?PBS_O_HOST) then
   ...
   setenv ARRAY_INDEX $PBS_ARRAY_INDEX
...
ls -l dart_restart        >>&   $logfile || exit 2
ls -l tiegcm_s.nc         >>&   $logfile || exit 2
ls -l tiegcm_restart_p.nc >>&   $logfile || exit 2
ls -l tiegcm.nml          >>&   $logfile || exit 2

# dart_to_model also generates 'namelist_update'
../dart_to_model >>& $logfile || exit 2
